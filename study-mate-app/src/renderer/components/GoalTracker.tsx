...
import { Box, VStack, HStack, Text, Heading, Button, Input, Badge, useColorModeValue, Icon } from '@chakra-ui/react';
...
const GoalTracker: React.FC = () => {
  ...
  const addGoal = () => {
    ...
    setNewGoal({ title: '', description: '', target: 1, unit: 'hours', deadline: '' });
          ...
          <Box p={4} borderWidth={1} borderRadius="md" borderColor="blue.200" bg="blue.50">
            <VStack spacing={3} align="stretch">
              ...
              <HStack spacing={3}>
                ...
                <Button size="sm" variant="outline" onClick={() => setIsAddingGoal(false)}>
                  Cancel
                </Button>
              </HStack>
            </VStack>
              ...
              <Box key={goal.id} p={4} borderWidth={1} borderRadius="md" borderColor={borderColor}>
                <VStack spacing={3} align="stretch">
                  <HStack justify="space-between" align="start">
                    <VStack align="start" spacing={1}>
                      ...
                      <Text fontSize="xs" color="gray.500">
                        Target: {goal.target} {goal.unit} | Deadline: {new Date(goal.deadline).toLocaleDateString()}
                      </Text>
                    </VStack>
                    <Button
                      size="sm"
                  ...
                  <HStack spacing={3} align="center">
                    ...
                    <Text fontSize="sm" fontWeight="600" color={`${getProgressColor(goal)}.500`}>
